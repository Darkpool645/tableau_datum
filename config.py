...
# Mapa producto (tal cual aparece cuando tipo == "Descuentos") -> área correcta.
# Las claves se comparan en minúsculas y sin espacios extremos.
# "Descuento" a secas no tiene entrada: se queda con el área en la que ya está.
DISCOUNT_AREA_MAP = {
    "descuento carrito 1": "Carrito 1",
    "descuento carrito 2": "Carrito 2",
    "descuento cs": "Callos de cortes",
    "descuento callos": "Callos de cortes",
    "descuento estética": "Estética",
    ...
    "green fee futbolero 50% desc": "Proshop",
}